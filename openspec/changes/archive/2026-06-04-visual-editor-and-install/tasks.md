...
- [x] 6.1 Verify `cargo test` passes — crop, state_size, preview mode, install_icon tests all green (33 Rust + 37 frontend tests passing)
- [x] 6.2 Write frontend tests: `ImageCropper` mouse events + `useDebounce` timing (see ImageCropper.test.tsx, useDebounce.test.tsx)
